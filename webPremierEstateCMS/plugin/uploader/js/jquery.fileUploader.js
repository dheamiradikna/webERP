...
(function ($) {
    ...
    $.fn.fileUploader = function (config) {
        ...
        config = $.extend({}, {
            ...
            allowedExtension: 'jpg|jpeg|gif|png|pdf|doc|docx|xls|xlsx',
        ...
        */
        ...
        function uploadChange($this) {
            ...
            if (isHtml5) {
                var filenameInfo = ''
                filenameInfo = filename += ' (' + px.getFileSizeName($this) + ')';
            }

            //if (px.ext(filename) != 'pdf') {
            //    debugger;
            //    if (px.getSize($this) == 'MB') {
            //        alert(filename + " Not Accepted. Max size 250KB");
            //    } else {
            //        if (px.getFileSize($this) > 500) {
            //            debugger;
            //            alert(filename + " Not Accepted. Max size 250KB");
            //        } else {
            ...
            //} else {
            //    if (px.getSize($this) == 'MB') {
            //        if (px.getFileSize($this) > 20) {
            //            alert(filename + " Not Accepted. Max size 20MB");
            //        } else {
            //            //DIsplay syled markup				
            //            $(pxUploadForm).append(
            //                $('<div>').attr({
