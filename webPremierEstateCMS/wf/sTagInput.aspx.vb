    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack Then
            ...
            If Trim(_save) = "1" Or Trim(_saveClose) = "1" Then
                ...
                If IsNumeric(temp) Then
                    If Trim(_save) = "1" Then
                        ...
                        'Response.Redirect(GetEncUrl(_rootPath + "wf/sTagInput.aspx?r=" + temp + "&", Hashtable))
                    ...
                    Else
                        If Trim(q_ref) <> "" Then
                            ...
                            'Response.Redirect(GetEncUrl(_rootPath + "wf/sTag.aspx?r=" + temp + "&", Hashtable))
            ...
            If Trim(_delete) = "1" Then
                ...
                If Trim(temp) = "" Then
                    'benar
                    Response.Redirect(GetEncUrl(_rootPath + "wf/sTag.aspx?", Hashtable))
            ...
            If Trim(q_ref) <> "" Then
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    ltrBtn.Text =  "  <a href=""javascript:doDelete('" + MyURLEncode(dt.Rows(0).Item("tagName")) + "');"" class=""btn btn-md btn-dark""><span>Delete</span></a> " + _
                                   "  <a href=""" + GetEncUrl(_rootPath + "wf/sTagInput.aspx?", Hashtable) + """ class=""btn btn-md btn-dark""><span>Insert New</span></a> " 
