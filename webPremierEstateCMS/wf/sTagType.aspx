<%@ Page Language="VB" MasterPageFile="~/wf/defWeb.master" AutoEventWireup="false" CodeFile="sTagType.aspx.vb" Inherits="wf_sTagType" title="" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function doSearch() {
            document.getElementById("_sTagType").value = "1";
            document.forms[0].submit();
        }
        
        function doDelete(ref, keyword) {
            if (confirm("Are you sure to delete this data \"" + keyword + "\" ?")) {
                document.getElementById("_sTagTypeDelete").value = ref;
                document.forms[0].submit();
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cMain" Runat="Server">
    <input id="_sTagType" name="_sTagType" type="hidden" value="" />
    <input id="_sTagTypeDelete" name="_sTagTypeDelete" type="hidden" value="" />
    ...
    <script type="text/javascript" language="javascript">
        ...
        <div class="row heading-row mt-50">
          <div class="col-md-12 text-center">
            <h2 class="heading uppercase"><small>Setting :: Tag Type</small> 
