...
Partial Class wf_mWebsiteCheckerPopup
    Inherits System.Web.UI.Page

    Protected rootPath As String = _rootPath

    Protected txtuserName As String = ""
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack Then
            ...
            If Trim(_save) = "1" Or Trim(_saveClose) = "1" Then
                ...
                If Trim(q_ref) <> "" Then
                    'update
                    temp = updateTagType(Session("userRef").ToString, q_ref, txtuserName)
                Else
                    'insert
                    temp = insertTagType(Session("userRef"), txtuserName, inputUN)
                End If
            ...
            If Trim(_delete) = "1" Then
                ...
                temp = deleteTagType(Session("userRef").ToString, q_ref)
                If Trim(temp) = "" Then
                    'benar
            ...
            If Trim(q_ref) <> "" Then
                ...
                If dt.Rows.Count > 0 Then
                    ltrBtn.Text = "<div class=""btn btn-md btn-dark""> " + _
                                    "  <a href=""javascript:doDelete('" + MyURLEncode(dt.Rows(0).Item("userName")) + "');"">Delete</a> " + _
                                    "</div> " + _
                                    "<div class=""btn btn-md btn-dark""> " + _
                                    "  <a href=""" + rootPath + "wf/mWebsiteCheckerPopup.aspx"">Insert New</a> " + _
                                    "</div> "

                    txtuserName = dt.Rows(0).Item("userName")
                End If
