<%@ Page Language="VB" AutoEventWireup="false" CodeFile="editForm.aspx.vb" Inherits="wf_support_EditForm" %>
...
<head runat="server">
    ...
    <link href="../../support/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        ...
        <div id="main_container">
            <div id="contentPopup" class="ov">
                ...
                <form id="cropper" name="cropper" runat="server">
                    ...
                    <div class="col-md-3" style="padding-bottom: 15px; display:none" >
