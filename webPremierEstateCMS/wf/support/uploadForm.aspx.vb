...
Imports System.IO
Partial Class wf_support_uploadForm
    ...
    Private Sub wf_support_uploadForm_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Trim(save_image) = "1" Then
            ...
            resultImage = insertIMG_TR_image(Session("domainRef").ToString, "", "", "", newW, newH, decodedBytes, Session("domain") + "_content_" + q_ref + "." + attachFileExt, inputUN)
