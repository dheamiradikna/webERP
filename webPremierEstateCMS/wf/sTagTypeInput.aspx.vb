...
Partial Class wf_sTagTypeInput
            ...
            If Trim(q_ref) <> "" Then
                ...
                If dt.Rows.Count > 0 Then
                    ltrBtn.Text = "<div class=""btn btn-md btn-dark""> " + _
                                    "  <a href=""javascript:doDelete('" + MyURLEncode(dt.Rows(0).Item("tagTypeName")) + "');""class=""btn btn-md btn-dark""><span>Delete</span></a> " + _
                                    "</div> " + _
                                    "<div class=""btn btn-md btn-dark""> " + _
                                    "  <a href=""" + rootPath + "wf/sTagTypeInput.aspx""class=""btn btn-md btn-dark""><span>Insert New</span></a> " + _
                                    "</div> "
