<%@ Page Language="VB" MasterPageFile="~/wf/defAdmin.master" AutoEventWireup="false" CodeFile="mUser.aspx.vb" Inherits="wf_admin_mUser" title="Natawebsite.com :: Master :: User" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function doSearch() {
            document.getElementById("_mUser").value = "1";
            document.forms[0].submit();
        }
        
        function doDelete(ref, keyword) {
            if (confirm("Are you sure to delete this data \"" + keyword + "\" ?")) {
                document.getElementById("_mUserDelete").value = ref;
                document.forms[0].submit();
            }
        }
        
        function doLoadDomain() {
            window.location = _rootPath + "wf/admin/mUser.aspx?d=" + document.getElementById("selDomain").value;
        }
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cMain" Runat="Server">
    <input id="_mUser" name="_mUser" type="hidden" value="" />
    <input id="_mUserDelete" name="_mUserDelete" type="hidden" value="" />
    <%--<div class="f2 bold bdrBottom ov">
        <div class="left mr10">
            <asp:Literal ID="ltrDomain" runat="server"></asp:Literal>
        </div>
        <div class="left">Master :: User</div>
        <div class="left mb5 ml10">
            <a href="javascript:showPopup(-1,-1,'<%=rootPath%>wf/admin/mUserPopup.aspx?d=<%=q_domainRef%>');"><img border="0" alt="input" src="<%=rootPath%>support/image/icon_add.png" height="20" /></a>
        </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row heading-row mt-50">
          <div class="col-md-12 text-center">
            <h2 class="heading uppercase"><small>Master :: User</small> 
                <a href="javascript:showPopup(-1,-1,'<%=rootPath%>wf/admin/mUserPopup.aspx?d=<%=q_domainRef%>');"><img border="0" alt="input" src="<%=rootPath%>support/image/icon_add.png" height="20" /></a>
           </h2>
          </div>
        </div>
