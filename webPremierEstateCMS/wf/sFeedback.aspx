<%@ Page Title="" Language="VB" MasterPageFile="~/wf/defWeb.master" AutoEventWireup="false" CodeFile="sFeedback.aspx.vb" Inherits="wf_sFeedback" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function doSearch() {
            document.getElementById("_sFeedback").value = "1";
            document.forms[0].submit();
        }

        function doDelete(ref, keyword) {
            if (confirm("Are you sure to delete this feedback \"" + keyword + "\" ?")) {
                document.getElementById("_sFeedbackDelete").value = ref;
                document.forms[0].submit();
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cMain" Runat="Server">
    <input id="_sFeedback" name="_sFeedback" type="hidden" value="" />
    <input id="_sFeedbackDelete" name="_sFeedbackDelete" type="hidden" value="" />
      ...
      <div class="container">
        ...
        <div class="row heading-row mt-50">
          <div class="col-md-12 text-center">
            <h2 class="heading uppercase"><small>Setting :: Feedback</small></h2>
          </div>
        </div>
