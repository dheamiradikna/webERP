<%@ Page Language="VB" MasterPageFile="~/wf/defWeb.master" AutoEventWireup="false" CodeFile="sTag.aspx.vb" Inherits="wf_sTag" title="" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cMain" Runat="Server">
    <input id="_sTag" name="_sTag" type="hidden" value="" />
    <input id="_sTagDelete" name="_sTagDelete" type="hidden" value="" />


<%--    <div class="f2 bold bdrBottom ov">
        <div class="left">Setting :: Tag</div>
        <div class="left mb5 ml10">
            <a href="javascript:showPopup(-1,-1,'<%=rootPath%>wf/sTagPopup.aspx?');"><img border="0" alt="input" src="<%=rootPath%>support/image/icon_add.png" height="20" /></a>
        </div>
    </div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        <div class="row heading-row mt-50">
          <div class="col-md-12 text-center">
            <h2 class="heading uppercase"><small>Setting :: Tag</small> 
                <a href="javascript:showPopup(-1,-1,'<%=rootPath%>wf/sTagPopup.aspx?');"><img border="0" alt="input" src="<%=rootPath%>support/image/icon_add.png" height="20" /></a>
                <%--<a href="<%=rootPath%>wf/sTagInput.aspx?;"><img border="0" alt="input" src="<%=rootPath%>support/image/icon_add.png" height="20" /></a>--%>
           </h2>
          </div>
        </div>
        ...
        <div class="row">
			...
			<div class="col-md-8">
				<input id="rbActive1" type="radio" class="input-radio" name="rbActive"  value="1" checked="checked" />
				<label for="rbActive1" >All</label>
				&nbsp;&nbsp;
				<input id="rbActive2" type="radio" class="input-radio" name="rbActive"  value="2" />
				<label for="rbActive2">Yes</label>
				&nbsp;&nbsp;
				<input id="rbActive3" type="radio" class="input-radio" name="rbActive"  value="3" />
				<label for="rbActive3">No</label>
			</div>    
        </div>
